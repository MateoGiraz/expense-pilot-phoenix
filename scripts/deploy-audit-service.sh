...
ECR_REPO="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/expense-pilot/audit-service"

echo "🚀 Deploying Audit Service to ECS..."
  ...
  "containerDefinitions": [
    {
      ...
      "environment": [
        ...
        },
        {
          ...
          "value": "4b5651277593a8b91e252d0dec73a116"
        },
        {
          "name": "API_SECRET_KEY",
...
echo "✅ Audit Service deployment complete!"
