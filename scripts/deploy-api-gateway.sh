...
ECR_REPO="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/expense-pilot/api-gateway"

echo "🚀 Deploying API Gateway to ECS..."
  ...
  "containerDefinitions": [
    {
      ...
      "environment": [
        ...
        },
        {
          ...
          "value": "http://auth-service:5439"
        },
        {
          "name": "EXPENSES_SERVICE_URL",
          "value": "http://expenses-service:4001"
        },
        {
