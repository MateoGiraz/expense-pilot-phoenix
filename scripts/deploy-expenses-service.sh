...
ECR_REPO="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/expense-pilot/expenses-service"
DATABASE_URL="postgres://postgres:expense-pilot-postgres@expense-pilot.c5buefi1ww4u.us-east-1.rds.amazonaws.com:5432/expenses_service_db"

echo "🚀 Deploying Expenses Service to ECS..."
...
echo "✅ Expenses Service deployment complete!"
