...
ECR_REPO="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/expense-pilot/auth-service"
DATABASE_URL="postgres://postgres:expense-pilot-postgres@expense-pilot.c5buefi1ww4u.us-east-1.rds.amazonaws.com:5432/auth_service_db"

echo "🚀 Deploying Auth Service to ECS..."
  ...
  "containerDefinitions": [
    {
      ...
      "environment": [
        ...
        {
          "name": "JWT_SECRET",
          "value": "my-super-secure-jwt-secret-key-for-development-change-in-production"
        },
        {
          "name": "API_SECRET_KEY",
          "value": "expense-pilot-internal-api-key-12345"
        }
      ],
      "logConfiguration": {
        "logDriver": "awslogs",
